...
const ConversationChat = ({ navigation, route }) => {
  ...
  return (
    ...
    >
      {/* Header */}
      <View className="bg-teal-500 p-4 border-b border-teal-600">
        <View className="flex-row items-center justify-between">
          ...
          <TouchableOpacity
            className="bg-teal-600 px-4 py-2 rounded-full"
      ...
      >
        {!conversationStarted && loading ? (
          ...
          <>
            {/* Welcome message */}
            <View className="bg-teal-50 border border-teal-200 rounded-xl p-4 mb-4">
