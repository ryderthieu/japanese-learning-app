...
import VocabSliderItem from "./VocabSliderItem";
import VocabPagination from "./VocabPagination";
    ...
    <View>
      <Animated.FlatList
        ...
        renderItem={({ item, index }) => (
          <VocabSliderItem item={item} index={index} scrollX={scrollX} />
        )}
        horizontal
      ...
      />
      <VocabPagination items={itemList} scrollX={scrollX} paginationIndex={paginationIndex} />
    </View>
  );
};
